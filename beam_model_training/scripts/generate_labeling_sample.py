...
if __name__ == "__main__":
    ...
    output_label_dir = DataTiler.create_if_not_exists(
        input_dir.parent / "sample/labels", overwrite=True
    )
    output_json_dir = DataTiler.create_if_not_exists(
        input_dir.parent / "sample/json", overwrite=True
    )
    ...
    png_output_dir = DataTiler.create_if_not_exists(
        sample_images_dir.parent / "png", overwrite=True
    )
